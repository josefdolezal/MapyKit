...
class Int_FastRPCSerializableTests: XCTestCase {
    ...
    func testSerializeNegativeNumbers() {
        XCTAssertEqual([UInt8](try (-500).serialize()), [65, 244, 1])
        XCTAssertEqual([UInt8](try (-1000).serialize()), [65, 232, 3])
        XCTAssertEqual([UInt8](try (-1500).serialize()), [65, 220, 5])
        XCTAssertEqual([UInt8](try (-2000).serialize()), [65, 208, 7])
        XCTAssertEqual([UInt8](try (-2500).serialize()), [65, 196, 9])
        XCTAssertEqual([UInt8](try (-3000).serialize()), [65, 184, 11])
        XCTAssertEqual([UInt8](try (-3500).serialize()), [65, 172, 13])
        XCTAssertEqual([UInt8](try (-4000).serialize()), [65, 160, 15])
        XCTAssertEqual([UInt8](try (-4500).serialize()), [65, 148, 17])
        XCTAssertEqual([UInt8](try (-5000).serialize()), [65, 136, 19])
        XCTAssertEqual([UInt8](try (-5500).serialize()), [65, 124, 21])
        XCTAssertEqual([UInt8](try (-6000).serialize()), [65, 112, 23])
        XCTAssertEqual([UInt8](try (-6500).serialize()), [65, 100, 25])
        XCTAssertEqual([UInt8](try (-7000).serialize()), [65, 88, 27])
        XCTAssertEqual([UInt8](try (-7500).serialize()), [65, 76, 29])
        XCTAssertEqual([UInt8](try (-8000).serialize()), [65, 64, 31])
        XCTAssertEqual([UInt8](try (-8500).serialize()), [65, 52, 33])
        XCTAssertEqual([UInt8](try (-9000).serialize()), [65, 40, 35])
        XCTAssertEqual([UInt8](try (-9500).serialize()), [65, 28, 37])
        XCTAssertEqual([UInt8](try (-10000).serialize()), [65, 16, 39])
    }

    func testSerializeZero() {
        XCTAssertEqual([UInt8](try 0.serialize()), [56, 0])
    }
}
